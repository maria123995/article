            ...
            <div class="content-body">
                ...
                <section id="basic-form-layouts">
                    <form class="form-horizontal" role="form" method="post"
                        action="{{ route('admin.supadmin.destroy', $admin->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $admin->title }}" name="title" id="title"
                                                placeholder="" class="form-control" />
                                            @error('admin.$index.title')
                                                <span>{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="date">
                                            التاريخ </label>
                                        <div class="col-sm-9">
                                            <input class="form-control fc-datepicker" value="{{ $admin->date }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="description" id="description"
                                                value="{{ $admin->description }}" placeholder="" class="form-control" />
                                            @error('admin.$index.description')
                                                <span>{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
